...
Menu rosalinaMenu = {
    "Extwa Goodies :3",
    {
        ...
        { "Scween filtewrs...", MENU, .menu = &screenFiltersMenu },
        { "New 3DS menu...", MENU, .menu = &N3DSMenu, .visibility = &menuCheckN3ds },
        { "oter optins...", MENU, .menu = &miscellaneousMenu },
        { "Save settings", METHOD, .method = &RosalinaMenu_SaveSettings },
        { "Powie off", METHOD, .method = &RosalinaMenu_PowerOff },
        { "weboot", METHOD, .method = &RosalinaMenu_Reboot },
        { "Cwedits", METHOD, .method = &RosalinaMenu_ShowCredits },
        { "Debug infwo", METHOD, .method = &RosalinaMenu_ShowDebugInfo, .visibility = &rosalinaMenuShouldShowDebugInfo },
        {},
    }
};
...
void RosalinaMenu_ShowCredits(void)
{
    ...
    {
        Draw_Lock();
        Draw_DrawString(10, 10, COLOR_TITLE, "CWEDITS UWU");

        u32 posY = Draw_DrawString(10, 30, COLOR_TITLE, "Luwuma3DS (L) 2023 X-X") + SPACING_Y;

        posY = Draw_DrawString(10, posY + SPACING_Y, COLOR_RED, "Luma3DS by Aurora Wright, TuxSH, and others");
